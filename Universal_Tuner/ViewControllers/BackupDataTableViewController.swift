...
class BackupDataTableViewController:UITableViewController {
    ...
    func loadBackupDataList() {
        ...
        let urlAdressAppendFftData = "http://" + ServerExchange.urlAddress + "/api/listBackups/"
    ...
    func useBackupDataAsMainData(file:String) -> Bool {
        ...
        let urlAdressAppendFftData = "http://" + ServerExchange.urlAddress + "/api/useBackupDataAsMainData/"
